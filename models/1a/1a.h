...
//Thread info 
const  int m_thread_cnt=4;
const  int theta_thread_cnt=8;

//Priors
const double m_diag=1;
...
const char* data="/data1/rahul/projects/text_mining/branch/punctuation/chris_data/AD";
//const char* dict_file="/home/rkumar2/final_test/data/word_list.txt" ;
//const char* data="/home/rkumar2/final_test/data/AE";
